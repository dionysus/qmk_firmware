...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        KC_ESC, MI_E1, MI_Gs1, MI_C2, MI_OCTD, MI_OCTU, 
        MI_Cs1, MI_F1, MI_A1, MI_Cs2, KC_2, KC_3, 
        MI_D1, MI_Fs1, MI_As1, MI_D2, KC_4, KC_5, 
        MI_Ds1, MI_G1, MI_B1, MI_Ds2, KC_6, KC_7, KC_8),
